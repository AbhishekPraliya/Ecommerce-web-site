...
// export const insertCategoriesInProducts = async (req, res) => {
//     try {
//         // Provided arrays of category ObjectIds
        
//         const idsArrays = [
//             ["686cf5381d373792d0563aa1", "686cf5381d373792d0563aa2"],
//             ["686cf5381d373792d0563aa5", "686cf5381d373792d0563aaa"],
//             ["686cf5381d373792d0563aae", "686cf5381d373792d0563aaf", "686cf5381d373792d0563ab1"]
//         ];
//         console.log("adding category");

//         // Convert string ids to mongoose ObjectId
//         const formattedIdsArrays = idsArrays.map(array =>
//             array.map(id => new mongoose.Types.ObjectId(id))
//         );

//         // Fetch all products with gender "male" or "unisex"
//         const eligibleProducts = await Product.find({
//             gender: { $in: ["female"] },
//         });

//         if (!eligibleProducts.length) {
//             return res.status(404).json({ message: "No eligible products found." });
//         }

//         // Loop through each eligible product and assign categories
//         const updates = [];
//         for (let i = 0; i < eligibleProducts.length; i++) {
//             const product = eligibleProducts[i];
//             const index = i % formattedIdsArrays.length;
//             product.categories = formattedIdsArrays[index];
...
//         console.log("data");
//         res.status(200).json({
//             message: `Updated ${updates.length} products with rotating category arrays.`,
//         });
//     } catch (error) {
